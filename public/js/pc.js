 ...
 * Indonesia
 */
function arraysort (array) { // eslint-disable-line no-unused-vars
...
function toRadians (angle) { // eslint-disable-line no-unused-vars
  return angle * (Math.PI / 180)
}

function warning (text) { // eslint-disable-line no-unused-vars
  console.warn(text)
}

function info (text) { // eslint-disable-line no-unused-vars
  console.info(text)
}

function error (text) { // eslint-disable-line no-unused-vars
  console.error(text)
}

function log (text) { // eslint-disable-line no-unused-vars
  console.log(text)
}

function pc (canvas) { // eslint-disable-line no-unused-vars
  this.canvas = canvas
  ...
  this.image2canvas = function (imgsrc) {
    var imageObj = new Image() // eslint-disable-line no-undef
    var parent = this
  ...
  this.hist2canvas = function (arr, fontsize) {
    ...
    let widthfontmax = context.measureText(txt1).width
    let widthfontmid = context.measureText(txt2).width // eslint-disable-line no-unused-vars
